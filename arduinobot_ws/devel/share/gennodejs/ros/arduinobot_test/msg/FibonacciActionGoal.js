...
// (in-package arduinobot_test.msg)
...
class FibonacciActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = FibonacciGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FibonacciActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = FibonacciGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new FibonacciGoal()
    }
...
module.exports = FibonacciActionGoal;
